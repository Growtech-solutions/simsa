    ...
    <aside class="min-w-[16rem] w-64 bg-white shadow-xl p-4 space-y-4 overflow-y-auto flex-shrink-0">
      ...
      <div x-data="{ open: false }" class="relative">
        ...
        <a href="general.php?header_loc=<?php echo $header_loc; ?>&pestaña=facturasproyectos" class="flex items-center gap-2 p-2 rounded hover:bg-blue-50 w-full text-left"><i data-lucide="layout-grid"></i>Proyectos</a>
          ...
          <li>
        <a href="general.php?header_loc=<?php echo $header_loc; ?>&pestaña=facturaspedidos" class="flex items-center gap-2 p-2 rounded hover:bg-blue-50 w-full text-left"><i data-lucide="layout-grid"></i>Contratos</a>
          <li>
      ...
      <div x-data="{ open: false }" class="relative">
        ...
        <a href="general.php?header_loc=<?php echo $header_loc; ?>&pestaña=analisis_beneficioservicios&tipo=proyectos" class="flex items-center gap-2 p-2 rounded hover:bg-blue-50 w-full text-left"><i data-lucide="list"></i>Beneficio</a>
          ...
          <li>
        <a href="general.php?header_loc=<?php echo $header_loc; ?>&pestaña=reporte_facturas_servicios" class="flex items-center gap-2 p-2 rounded hover:bg-blue-50 w-full text-left"><i data-lucide="chart-network"></i>Facturas</a>
          </li>
          <li>
