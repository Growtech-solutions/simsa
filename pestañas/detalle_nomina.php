...
<div class="container py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="/php/timbrar_nomina.php?id_periodo=<?php echo $periodo_id; ?>" class="btn btn-success">✅ Timbrar todo el periodo</a>
  </div>

  <?php
    include 'calculo_nomina.php';
  ?>
        ...
        <tbody>
          <?php foreach ($trabajadores_nomina as $trabajador): ?>
            ...
            <tr>
              ...
              $result_nomina = $conexion->query($sql_nomina);
