...
$conexion_transimex = mysqli_connect($host_transimex, $usuario_transimex, $contrasena_transimex, $base_de_datos_transimex);
...
$stmt_trabajador = $conexion_transimex->prepare($sql_trabajador);
...
$stmt_complemento = $conexion->prepare($sql_complemento);
